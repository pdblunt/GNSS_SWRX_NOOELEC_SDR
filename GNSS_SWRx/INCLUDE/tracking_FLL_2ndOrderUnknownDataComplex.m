function [trackResults, channel]= tracking_FLL_2ndOrderUnknownDataComplex(fid_I, fid_Q, channel, settings)
% Performs code and carrier tracking for all channels.
%
%[trackResults, channel] = tracking_FLL_2ndOrderUnknownDataComplex(fid_I, fid_Q channel, settings)
%
%   Inputs:
...
%             iBasebandSignal = carrCos .* rawSignal_I;
%             qBasebandSignal = -1*carrSin .* rawSignal_I;

%             iBasebandSignal = carrSin .* rawSignal_I;
%             qBasebandSignal = carrCos .* rawSignal_I;
